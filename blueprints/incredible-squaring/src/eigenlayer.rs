...
impl GadgetRunner for EigenlayerGadgetRunner<parking_lot::RawRwLock> {
    ...
    async fn register(&mut self) -> Result<()> {
        ...
        // );
        //
        // let setup_config = eigensdk_rs::incredible_squaring_avs::avs::SetupConfig::<NodeConfig> {
        ...
        // };
        //
        // let incredible_squaring_contract_manager = eigensdk_rs::incredible_squaring_avs::avs::IncredibleSquaringContractManager::build(
        ...
        // let avs_registry_contract_manager = eigensdk_rs::eigen_utils::avs_registry::AvsRegistryContractManager::build(
        ...
        // let aggregator_rpc_client = eigensdk_rs::incredible_squaring_avs::rpc_client::AggregatorRpcClient::new(config.server_ip_port_address.clone());
        //
        // info!("Building Eigenlayer Contract Manager...");
        // let eigenlayer_contract_manager = el_contracts::ElChainContractManager::build(
        //     setup_config.delegate_manager_addr,
        //     setup_config.avs_directory_addr,
        //     eth_client_http.clone(),
        //     eth_client_ws.clone(),
