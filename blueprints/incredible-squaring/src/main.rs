...
use gadget_sdk::events_watcher::substrate::EventHandler;
...
impl GadgetRunner for TangleGadgetRunner {
    ...
    async fn run(&self) -> Result<()> {
        ...
        // for each autogenerated EventHandler, simply call init().await to kick it off (for now), we need a better design.
        x_square.init().await;
