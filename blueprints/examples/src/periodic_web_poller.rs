...
//
// type ProcessorError = blueprint_sdk::event_listeners::core::Error<Error>;
//
// pub fn constructor(cron: &'static str) -> impl InitializableEventHandler {
//     WebPollerEventHandler {
//         context: WebPollerContext(cron),
//     }
// }
//
// #[job(
...
// pub async fn web_poller(context: WebPollerContext, value: bool) -> Result<u8, Infallible> {
...
//
//     async fn new(context: &reqwest::Client) -> Result<Self, ProcessorError>
//     where
//         Self: Sized,
//     {
//         Ok(Self {
