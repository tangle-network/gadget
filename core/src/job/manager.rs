use super::protocol::{
    DeliveryType, PollMethod, ProtocolMessageMetadata, ProtocolRemote, ShutdownReason,
    WorkManagerInterface,
};
use super::ExecutableJob;
...
mod tests {
    use super::*;
    use crate::job::builder::{BuiltExecutableJobWrapper, JobBuilder};
