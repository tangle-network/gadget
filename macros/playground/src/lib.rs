...
pub fn keygen_empty_result_type(context: TangleClient, n: u16, t: u16) -> () {
    let _ = (n, t, context);
}

/// Simple Threshold (t) Keygen Job for n parties.
#[job(id = 0, params(n, t), event_listener(listener = TangleEventListener<TangleClient, JobCalled>, pre_processor = services_pre_processor))]
pub fn keygen_implicit_empty_result_type(context: TangleClient, n: u16, t: u16) {
    let _ = (n, t, context);
}

/// Simple Threshold (t) Keygen Job for n parties.
#[job(id = 0, params(n, t), event_listener(listener = TangleEventListener<TangleClient, JobCalled>, pre_processor = services_pre_processor))]
pub fn keygen_fixed_array_return_type(context: TangleClient, n: u16, t: u16) -> [u8; 2] {
    let _ = (n, t, context);
    [0, 1]
}
...
/// Simple Threshold (t) Keygen Job for n parties.
#[job(id = 0, params(n, t), event_listener(listener = TangleEventListener<TangleClient, JobCalled>, pre_processor = services_pre_processor))]
pub fn keygen_custom_return_type(context: TangleClient, n: u16, t: u16) -> TestReturnType {
    let _ = (n, t, context);
    TestReturnType
}
