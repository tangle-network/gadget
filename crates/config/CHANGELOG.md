...
## [0.1.0](https://github.com/tangle-network/gadget/releases/tag/gadget-config-v0.1.0) - 2025-02-23

### Added

- new networking ([#664](https://github.com/tangle-network/gadget/pull/664))
- Add multinode test executor
- *(cargo-tangle)* eigenlayer run and key commands ([#670](https://github.com/tangle-network/gadget/pull/670))
