...
## [0.1.0](https://github.com/tangle-network/gadget/releases/tag/gadget-networking-v0.1.0) - 2025-02-27
...
- update some tests
- *(networking)* remove relay client from behavior ([#663](https://github.com/tangle-network/gadget/pull/663))
...
- Improve appearance and dev experience ([#679](https://github.com/tangle-network/gadget/pull/679))
