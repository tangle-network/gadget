...
impl TangleRuntimeClient {
    ...
    pub async fn from_url<U: AsRef<str>>(url: U, account_id: AccountId32) -> Result<Self> {
    ...
    ///
    /// ```no_run
    /// use gadget_clients_tangle::runtime::TangleRuntimeClient;
    /// use subxt::utils::AccountId32;
    ///
    /// # async fn foo() -> gadget_clients_tangle::errors::Result<()>{
