use super::round_based_p2p::P2PProtocol;

#[async_trait::async_trait]
impl P2PProtocol for P2PClient {
    type PublicKey = subxt_core::ext::sp_core::ecdsa::Public;
    ...
    {
        Ok(
            crate::network::round_based_compat::NetworkDeliveryWrapper::new(
                mux,
                party_index,
                task_hash,
                parties,
    ...
    // TODO: THESE METHODS BELONG IN SERVICES
    ...
    //     (
    //         usize,
    //         BTreeMap<AccountId32, subxt_core::ext::sp_core::ecdsa::Public>,
    //     ),
    //     Error,
    // > {
    // }
    ...
    //     &self,
    // ) -> Result<BTreeMap<AccountId32, subxt_core::ext::sp_core::ecdsa::Public>, Error> {
    // }
