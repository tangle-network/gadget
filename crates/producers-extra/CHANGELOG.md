...
## [0.1.0](https://github.com/tangle-network/gadget/releases/tag/blueprint-producers-extra-v0.1.0) - 2025-03-06

### Added

- re-integrate the blueprint configs ([#28](https://github.com/tangle-network/gadget/pull/28))
- add CronJob producer ([#25](https://github.com/tangle-network/gadget/pull/25))
