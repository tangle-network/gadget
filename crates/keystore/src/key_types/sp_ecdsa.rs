...
impl KeyType for SpEcdsa {
    type Public = sp_core::ecdsa::Public;
    type Secret = sp_core::ecdsa::Pair;
    ...
    fn verify(public: &Self::Public, msg: &[u8], signature: &Self::Signature) -> bool {
        <sp_core::ecdsa::Pair as Pair>::verify(signature, msg, public)
    }
}
