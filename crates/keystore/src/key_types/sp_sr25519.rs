...
impl KeyType for SpSr25519 {
    ...
    fn verify(public: &Self::Public, msg: &[u8], signature: &Self::Signature) -> bool {
        <sp_core::sr25519::Pair as Pair>::verify(signature, msg, public)
    }
}
