...
impl KeyType for SpEd25519 {
    ...
    fn verify(public: &Self::Public, msg: &[u8], signature: &Self::Signature) -> bool {
        <sp_core::ed25519::Pair as Pair>::verify(signature, msg, public)
    }
}
