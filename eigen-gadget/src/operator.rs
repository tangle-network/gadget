...
mod tests {
    ...
    async fn run_anvil_testnet() -> ContractAddresses {
        ...
        let delegation_manager_addr = address!("0165878a594ca255338adfa4d48449f69242eb8f");
        let service_manager_addr = address!("610178da211fef7d417bc0e6fed39f05609ad788");
        let stake_registry_addr = address!("cf7ed3acca5a467e9e704c703e8d87f634fb0fc9");
        let bls_apk_registry_addr = address!("9fe46736679d2d9a65f0992f2272de9f3c7fa6e0");
        let index_registry_addr = address!("e7f1725e7734ce288f8367e1bb143e90bb3f0512");
        let strategy_manager_addr = address!("8fbdb2318678afecb368f032d93f642f64180aa6");
        let task_manager_addr = address!("C02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2");
        ...
        let eigen_pod_manager = EigenPodManager::deploy(
            provider.clone(),
            address!("73e42f117e8643cc03a4197c6c3ab38d8e5bd281"), //ethPOS
            address!("83e42f117e8643cc01741973ac7cb3ad8e5bd282"), //eigenPodBeacon
